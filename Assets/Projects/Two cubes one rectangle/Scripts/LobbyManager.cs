...
public class LobbyManager : MonoBehaviour
{
	...
	{
		startButton.onClick.AddListener(StartHostWithRelay);
	}

	private void OnDisable()
	{
		startButton.onClick.RemoveListener(StartHostWithRelay);
	}
	...
	public void UserEnteredRelayCode(string _relayCode)
	{
	...
	public void StartHostWithRelay()
	{
		...
		bootstrapManager.StartHostWithRelay(4, "udp");
	}

	public void JoinRelay()
	{
		bootstrapManager.StartClientWithRelay(relayCode, "udp");
	}
	...
	public async void QuickJoin()
	{
		try
		{
			...
			if (lobby != null)
			{
				...
				await bootstrapManager.StartClientWithRelay(lobby.Data["RelayCode"].Value, "udp");
			}
			// ...
		}
		catch (LobbyServiceException e)
	...
	public async void Query()
	{
		try
		{
			...
			foreach (Lobby lobbiesResult in lobbies.Results)
			{
				...
				// individualLobbyUI.GetComponent<LobbyPanel_Model>().relayCode = lobbiesResult.Data["RelayCode"].Value; optional slightly easier version
